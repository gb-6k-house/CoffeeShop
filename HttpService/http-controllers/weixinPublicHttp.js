...
exports.authorize = function(req, res, next) {
    rpc.callWX(function(remote){
        try{
            ...
            remote.authorize(confige.wxPublic, function(e, oauthaccess){
                if (e){
                    http.sendData(res, eCode.UnkownError, '操作失败', null);
                }else{
                    http.sendData(res, eCode.Success, '操作成功',{oauthaccess:oauthaccess});
                }
            });
        }catch (e){
            http.sendData(res, eCode.UnkownError, '操作失败', null);
...
exports.userInfo = function(req, res, next) {
    rpc.callWX(function(remote){
        try{
            ...
            remote.weixinUser(req.body.openid, function(e, info){
                if (e){
                    http.sendData(res, eCode.UnkownError, '操作失败', null);
                }else{
                    http.sendData(res, eCode.Success, '操作成功',info);
                }
            });
        }catch (e){
            http.sendData(res, eCode.UnkownError, '操作失败', null);
